...
def convpool_block(inputs: tf.keras.layers.Layer, filters: int, n_convs: int = 2) -> tf.keras.layers.Layer:
...
def upconv_block(
    inputs: tf.keras.layers.Layer, skip: tf.keras.layers.Layer, filters: int, n_convs: int = 2
...
def residual_block(inputs: tf.keras.layers.Layer, filters: int) -> tf.keras.layers.Layer:
...
def logit_block(inputs: tf.keras.layers.Layer, n_channels: int) -> tf.keras.layers.Layer:
